...
export default function Transactions() {
  ...
  const handleGeneratePDF = () => {
    axios
      .get(`http://localhost:8080/api/v1/generatePDF/${accountID}`, { responseType: 'blob' })  
      .then((response) => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-end mt-4 mr-12">
        <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700" onClick={() => handleGeneratePDF()}>
